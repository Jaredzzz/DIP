...
QImage calculateHistogram(QImage &image, ImageChannel channel); //计算直方图函数
QImage calculateNegative(QImage &image, ImageChannel channel); //计算负值图函数
QImage convertToPseudoColor(QImage &image, ColorMap map);
QImage equalizeHistogramProc(QImage &image);  //平衡直方图
